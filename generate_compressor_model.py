...
def main():
    ...
    parser.add_argument("--output-format", choices=["h", "json"], default="c-header", help="File output format. Default: h.")
    ...
    if args.output_format == "": 
        ...
        import json
        out = json.dumps({ 
            'chrs_by_chr_id':successors.keys(),
            'chr_ids_by_chr':chrs_reversed,
            'successor_ids_by_chr_id_and_chr_id':successors_reversed.values(),
            ...
            'packs':  
               [{
                    ...
                    'packed': best_encodings[i].packed,
                    'unpacked':best_encodings[i].unpacked,
                    'offsets':best_encodings[i].offsets.consecutive,
                    'masks':best_encodings[i].masks.consecutive,
                    'header_mask':best_encodings[i].header_mask,
                    'header':best_encodings[i].header_code
                } for i in range(args.encoding_types)]
